    ...
    <div className='mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0'>
      {
        cartItem.length > 0 ? <div>
          ...
          <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-20'>
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                ...
                <button type="button" onClick={() => alert("Form submitted")} className="bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-md w-full sm:w-auto" >
                  Submit
                </button>
                ...
                <div className='flex justify-center'>
                  <button type="button" onClick={getLocation} className="bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-md w-full sm:w-auto text-center">
                    Detect Location
                  </button>
              ...
              <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                ...
                <button type="button" onClick={() => { alert("Proceeding to checkout"); }}
                  className="w-full bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300 text-center">
                  Proceed to Checkout
                </button>
          ...
          <button type="button" onClick={() => navigate('/product')} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md w-full sm:w-auto text-center">
            Continue Shopping
          </button>
